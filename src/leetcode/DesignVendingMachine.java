...
abstract class AbstractState implements State {
    protected DesignVendingMachine vendingMachine;

    public AbstractState(DesignVendingMachine vendingMachine) {
...
class NoSelectionState extends AbstractState{
    ...
    public NoSelectionState(DesignVendingMachine vendingMachine) {
...
class HasSelectionState extends AbstractState{
    ...
    public HasSelectionState(DesignVendingMachine vendingMachine) {
        super(vendingMachine);
        // TODO Auto-generated constructor stub
    }
...
class InsertedMoneyState extends AbstractState{
    ...
    public InsertedMoneyState(DesignVendingMachine vendingMachine) {
        super(vendingMachine);
        // TODO Auto-generated constructor stub
    }
